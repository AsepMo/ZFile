...
import com.store.data.engine.app.CrashReportingManager;
...
public class SettingsActivity extends AppCompatPreferenceActivity
{
	...
	{
		Intent mApplication = new Intent(c, SettingsActivity.class);
	...
	{
        return PreferenceManager.getDefaultSharedPreferences(DataApplication.getInstance().getBaseContext())
	...
	{
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(DataApplication.getInstance().getBaseContext());
