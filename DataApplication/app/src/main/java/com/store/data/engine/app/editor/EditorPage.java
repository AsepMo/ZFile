...
public class EditorPage
{
     ...
     */
    public EditorPage setCustomFont(String path) {
    ...
    public EditorPage addScriptEditor(final Activity c, String title) {
    ...
    public EditorPage addHtmlEditor(final Activity c, String title) {
        Element editorElement = new Element();
        editorElement.setTitle(title);
        editorElement.setIconDrawable(R.drawable.ic_create_script);
        editorElement.setOnClickListener(new View.OnClickListener() {
    ...
    public EditorPage addItem(Element element) {
     ...
     */
    public EditorPage setImage(@DrawableRes int resource) {
     ...
     * @return this DashboardPage instance for builder pattern support
     */
    public EditorPage addGroup(String name) {
     ...
     * @return this DashboardPage instance for builder pattern support
     */
    public EditorPage isRTL(boolean value) {
        this.mIsRTL = value;
        return this;
    }

    public EditorPage setDescription(String description) {
