...
import com.store.data.engine.app.ftp.database.FTPDbSchema.ConnectionTable;
import com.store.data.engine.app.ftp.database.FTPDbSchema.SourceTable;
import com.store.data.engine.app.ftp.database.FTPBaseHelper;
