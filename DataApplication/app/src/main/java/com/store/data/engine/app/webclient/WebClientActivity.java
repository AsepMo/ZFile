...
public class WebClientActivity extends AppCompatActivity
{
	...
	//private static String ASWV_URL_OFFLINE      = SmartWebView.ASWV_URL_OFFLINE;
	private static String ASWV_URL_ONLINE      = SmartWebView.ASWV_URL_ONLINE;

	private static String ASWV_F_TYPE   = SmartWebView.ASWV_F_TYPE;

    public static String ASWV_HOST		= aswm_host(ASWV_URL_ONLINE);
    ...
    protected void onCreate(Bundle savedInstanceState)
	{
        ...
        if (ASWP_RATINGS)
		{
            handler.postDelayed(new Runnable() { public void run()
					{ get_rating(); }}, 1000 * 60); //running request after few moments
        }
		...
		{
			ActivityCompat.requestPermissions(WebClientActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, loc_perm);
		}
		get_location();
		...
		asw_view.setDownloadListener(new DownloadListener() {
				...
				public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimeType, long contentLength)
				{
					...
					{
						ActivityCompat.requestPermissions(WebClientActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE}, file_perm);
					}
					else
					{
		...
		asw_view.addJavascriptInterface(new JavaScriptInterface(this), "JSInterface");
        asw_view.setVerticalScrollBarEnabled(false);
        asw_view.setWebViewClient(new Callback());

        //Rendering the default URL
        aswm_view(ASWV_URL_ONLINE, false);
				...
				public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback, FileChooserParams fileChooserParams)
				{
					...
					if (ASWP_FUPLOAD)
					{
						...
						if (ASWP_CAMUPLOAD)
						{
							...
							if (takePictureIntent.resolveActivity(WebClientActivity.this.getPackageManager()) != null)
							{
								File photoFile = null;
								try
								{
    ...
    public void onResume()
	{
        ...
        if (Build.VERSION.SDK_INT >= 23)
		{
            ...
            WebClientActivity.this.setTaskDescription(taskDesc);
        }
        get_location();
    }
	...
	public boolean url_actions(WebView view, String url)
	{
		...
		if (!ASWP_OFFLINE && !DetectConnection.isInternetAvailable(WebClientActivity.this))
		{
	...
	public void get_info()
	{
		...
		cookieManager.setCookie(ASWV_URL_ONLINE, "DEVICE=android");
		cookieManager.setCookie(ASWV_URL_ONLINE, "DEV_API=" + Build.VERSION.SDK_INT);
	}
	...
	public void get_file()
	{
		...
		{
			ActivityCompat.requestPermissions(WebClientActivity.this, perms, file_perm);
		...
		{
			ActivityCompat.requestPermissions(WebClientActivity.this, new String[]{Manifest.permission.CAMERA}, file_perm);
		}
	}
    ...
    public void get_location()
	{
		...
		if (ASWP_LOCATION && ((Build.VERSION.SDK_INT >= 23 && check_permission(1)) || Build.VERSION.SDK_INT < 23))
		{
			...
			cookieManager.setAcceptCookie(true);
			GPSTrack gps;
			gps = new GPSTrack(WebClientActivity.this);
			...
			if (gps.canGetLocation())
			{
				...
				{
					cookieManager.setCookie(ASWV_URL_ONLINE, "lat=" + latitude);
					cookieManager.setCookie(ASWV_URL_ONLINE, "long=" + longitude);
	...
	{
        if (DetectConnection.isInternetAvailable(WebClientActivity.this))
		{
            AppRate.with(this)
    ...
    public void show_notification(int type, int id)
	{
        ...
        asw_notification = (NotificationManager) WebClientActivity.this.getSystemService(Context.NOTIFICATION_SERVICE);
        Intent i = new Intent();
        if (type == 1)
		{
            i.setClass(WebClientActivity.this, WebClientActivity.class);
        }
		else if (type == 2)
		{
		...
		else
		{
            ...
            i.setData(Uri.parse("package:" + WebClientActivity.this.getPackageName()));
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(WebClientActivity.this, 0, i, PendingIntent.FLAG_UPDATE_CURRENT);

        Uri alarmSound = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION);

        NotificationCompat.Builder builder = new NotificationCompat.Builder(WebClientActivity.this, "");
        switch (type)
		{
            case 1:
