...
import static com.store.data.engine.app.settings.SettingsActivity.KEY_ACCENT_COLOR;
import static com.store.data.engine.app.settings.SettingsActivity.KEY_PRIMARY_COLOR;
import static com.store.data.engine.app.settings.SettingsActivity.KEY_THEME_STYLE;
